...
Fictitious Banking Application GraphQL. This application was generated with the Angular CLI and is an Angular (www.angular.io) + GraphQL application that has been deployed to the following url on Heroku:
...
Or create new accounts on the web site via user registration.
...
07. For example Login with these credentials: phone:0712340987, password:kayode.
...
01. Clone the app to a folder on your local computer, say vbg-gql.
02. Navigate to the local folder by running, $ cd vbg-gql.
...
This application depends on a NestJS GraphQL API that is hosted on Heroku at the following url address:

https://vbag.herokuapp.com

With GraphQL Playground here:
